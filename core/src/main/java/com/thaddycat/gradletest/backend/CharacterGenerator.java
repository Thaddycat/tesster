...
public class CharacterGenerator {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                switch (key) {
                    ...
                    case "SP":
                        ...
                        break;
                    case "Position":
                        String[] coords = value.replaceAll("[^0-9,]", "").split(","); // Remove non-numeric chars
    ...
    public static void saveToFile(GameCharacter character, String filePath) throws IOException {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath))) {
            writer.write("PC: " + (character instanceof PCCharacter));
            writer.newLine();
...
// Preserved reworked CharacterGenerator to assign sprite value
...
public class CharacterGenerator {
    ...
    public static GameCharacter loadFromFile(String filePath) throws IOException {
        ...
        // set default charatcer sprite
        if (spritePath.isEmpty()) {
            spritePath = isPC ? "john.png" : "jane.png";
        }

        // Create PC/NPC based on the "PC" flag
        GameCharacter character = isPC ?
            new PCCharacter(name, position, resourcePoints, spritePath) :
            new NPCCharacter(name, position, resourcePoints, spritePath);
